...
public class JDTUtilsLTEImpl implements IJDTUtils {
	 ...
	 ******************************************************************************/
		...
		private static final IJDTUtils INSTANCE = new JDTUtilsLTEImpl();

		public static <T> T getInstance() {
			return (T) INSTANCE;
		}

		private JDTUtilsLTEImpl() {
		}
		...
		public void discoverSource(IClassFile classFile, IProgressMonitor monitor) throws CoreException {
			// No-op - This appears to be optional
		}
		...
		public String getJavadoc(IMember member, DocumentFormat documentFormat) throws JavaModelException {
			return "TODO - supply Javadoc description";
			/*
